...
- **public String toString()**: Returns a reduced String representation of this rational number, such as "3/5" or "1/2" versus "3/6". You should omit denominators of 1, returning "4" instead of "4/1".
